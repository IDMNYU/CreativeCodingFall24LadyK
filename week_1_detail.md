...
<td valign="top">do</td>
	<!-- day Tues -->
 	<td valign="top"> 
 		...
 		<li><a href = "https://join.slack.com/t/nyu-sbq4415/shared_invite/zt-2pt0dov8m-fQR2KJWSEW2ELVbltfh1xw">Join the Slack workspace for this course. Make sure your workspace name is the name to address you by</li> </a>
 		<li> <a href = "https://openprocessing.org/join/2B6B0B"> Join our workspace on openProcessing via this invitation link.</a> This is critical as this is where you will be submitting your homework.</li>
 		<li>Fill out the <a href ="https://forms.gle/RxGhizGYkoi2gNyj8" >Google Survey</a> if you have not already
...
<li>3.1 Flow (Setup and draw) - https://youtu.be/o8dffrZ86gs</li>
  	...
  	<!-- day Thurs -->
  	<td valign="top"> 
  	<li><a href = "Sketch_1.md"> Sketch 1 Announced</a></li>
...
<li>3.2 Built-in Variables (mouseX, mouseY) - https://youtu.be/ibW4oA7-n8I</li>
 	...
 	<li><a href = "Sketch_1.md"> Sketch 1</a>. Do not do it in one sitting. Do ask questions in class as you work on it.</li>
 	</td>
</tr>
</table>